function _level001() {
	...
	this.PrimaryDispatch = function() {
		...
		jukebox.play("crestoe-caverns-of-the-forgotton");
	...
	this.SecondaryDispatch = function() {
		...
		this.playable.SetDirection(this._direction.Right);
		this.hud_manager.inventory[this._consumable.Coin] = 0;
		jukebox.play("crestoe-unsettling-waters-(ocean-battlefield)");
	...
	this.RequirementMet = function() {
		...
		var total = this.primary[3].boundary.length;
		this.primary[3].boundary[total-1].setRectangle(0, 0, 0, 0);
