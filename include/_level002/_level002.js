function _level002() {
	...
	this.LoadBlock = function() {
		...
		this.primary = new Array(12);

		this.primary[0] = new _level002_block200();
		this.primary[1] = new _level002_block201();
		this.primary[2] = new _level002_block202();
		this.primary[3] = new _level002_block203();
		this.primary[4] = new _level002_block204();
		this.primary[5] = new _level002_block205();

		this.primary[6] = new _level002_block206();
		this.primary[7] = new _level002_block207();
		this.primary[8] = new _level002_block208();

		this.primary[9] = new _level002_block209();
		this.primary[10] = new _level002_block210();
		this.primary[11] = new _level002_block211();

		this.primary[12] = new _level002_block212();
		this.primary[13] = new _level002_block213();
		this.primary[14] = new _level002_block214();

		this.primary[15] = new _level002_block218();
		this.primary[16] = new _level002_block219();
		this.primary[17] = new _level002_block220();
	...
	this.PrimaryDispatch = function() {
		...
		this.viewport_manager.SetWorldSize(1920, 960); // (world.w/320)-((parallax.w-320)/320)
		this.viewport_manager.SetPoint(0, 100);

		this.playable.SetPoint(20, 200);
	...
	this.DrawParallax = function() {
		...
		display.logical_display.drawImage(this.primary_parallax,
			parseInt(this.viewport_manager.x/-5), parseInt(this.viewport_manager.y/-3));
		return;
	}
