...
function _level002_block219() {
	...
	this.Create = function() {
		...
		this.x = 320; this.y = 720;
		this.w = 320; this.h = 240;

		this.background = new Image();
		this.background.src = 'agartha/stage-219.png';
	...
	this._boundary = function() {
		...
		//      1234567890ABCDEF
		text = "XX0000000000XXXX";
		text+= "XX00000000XXXXXX";
		text+= "XXX000000XXXXXXX";
		text+= "XXXXX0000XXXXXXX";
		text+= "XXXXXX000XXXXXXX";
		text+= "XXXXXX000XXXXXXX";
		text+= "XXXXX00000X0XXXX";
		text+= "XXX0000000000000";
		text+= "XX00000000000000";
		text+= "X00000000000000X";
		text+= "0000000000000XXX";
		text+= "00000000000XXXXX";
